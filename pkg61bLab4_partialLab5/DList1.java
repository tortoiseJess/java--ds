...
public class DList1 {
  ...
  /**
   *  DList1() constructor for an empty DList1. check is head ==null
   */
  public DList1() {
    head = null;
    tail = null;
  ...
  /**
   *  DList1() constructor for a one-node DList1. check is size 
   */
  public DList1(int a) {
    head = new DListNode1();
    tail = head;
  ...
  public void insertFront(int i) {
    // Your solution here.
      ...
      else { // is a more than one node special case necessary?
